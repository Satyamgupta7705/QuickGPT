    ...
    <div>
      {message.role === 'user' ? (
        <div className='flex items-start justify-end mb-4 gap-2'>
          <div className='flex flex-col gap-2 p-2 px-4 bg-slate-50 dark:bg-[#57317C]/30 border border-[#80609F]/30
        ...
        <div className='inline-flex flex-col p-2 px-4 max-w-2xl bg-primary/20 dark:bg-[#57317C]/30 border border-[#80609F]/30 rounded-md my-4 gap-2'>
           {message.isImage ? (
