  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="flex items-center gap-2 mt-4 p-3  border
    border-gray-300 dark:border-white/15 rounded-md cursor-pointer hover:scale-103 transition-all"
      >
        <img
      ...
      >
        ...
        <div className="flex flex-col text-sm">
          ...
          <p className="text-xs text-gray-400">
            Purchase credits to use a quickgpt
          </p>
        </div>
      </div>

      <div
        className="flex items-center justify-between gap-2 mt-4 p-3  border
    border-gray-300 dark:border-white/15 rounded-md "
      ...
      <div
        className="flex items-center gap-3 mt-4 p-3  border border-gray-300 dark:border-white/15 
